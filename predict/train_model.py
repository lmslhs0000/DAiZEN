...
train_df = pd.read_csv('raw/ex_train.csv')
val_df = pd.read_csv('raw/ex_val.csv')
...
class DataWindow():
    ...
    def split_to_inputs_labels(self, features):
        ...
        inputs.set_shape(
            [None, self.input_width, None]
        )

        labels.set_shape(
            [None, self.label_width, None]
        )
    ...
    def plot(
        ...
        for n in range(max_n):
            ...
            if self.label_columns:
                ...
                label_col_index = (
                    self.label_columns_indices.get(
                        plot_col,
                        None
                    )
                )
